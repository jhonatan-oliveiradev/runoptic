...
pub fn tr(lang: &str, key: &str) -> &'static str {
    ...
    match (l, key) {
        ...
        ("zh", "quit_app") => "退出 RunOptic",
        ("zh-Hant", "quit_app") => "結束 RunOptic",
        ("ja", "quit_app") => "RunOptic を終了",
        ("ko", "quit_app") => "RunOptic 종료",
        ("ru", "quit_app") => "Выйти из RunOptic",
        ("uk", "quit_app") => "Вийти з RunOptic",
        (_, "quit_app") => "Quit RunOptic",
        ("zh", "settings") => "设置…",
        ("zh-Hant", "settings") => "設定…",
        ("ja", "settings") => "設定…",
        ("ko", "settings") => "설정…",
