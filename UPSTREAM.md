...
RunOptic is an independent project and is not presented as an official Codenotch
edition or as endorsed by the upstream author.

## Development policy

Broadly useful upstream fixes may be contributed back where appropriate.
RunOptic-specific architecture, branding, telemetry normalization, Windows + WSL
environment discovery, gateway observability, local-runtime telemetry and
historical analysis evolve independently.
